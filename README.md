...
**[Download Science Lens 1.0.2 (.xpi)](https://github.com/AriyanBe/Science-Lense/releases/download/v1.0.2/science-lens-1.0.2.xpi)** · [All releases](https://github.com/AriyanBe/Science-Lense/releases) · [Report an issue](https://github.com/AriyanBe/Science-Lense/issues)
...
1. Download **[science-lens-1.0.2.xpi](https://github.com/AriyanBe/Science-Lense/releases/download/v1.0.2/science-lens-1.0.2.xpi)**. You can also find it under **Assets** on the [release page](https://github.com/AriyanBe/Science-Lense/releases/latest).
...
Updates are **manual** in version 1.0.2. Download a newer `.xpi` from this repository's Releases page when available and install it through Zotero's Plugins window.
...
| Automatic update check fails | Version 1.0.2 has no hosted update service. Install new releases manually. |
